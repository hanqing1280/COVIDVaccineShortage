...
% Method: LSQ WITH Initial Values Being Parameters
...
global np nps npperc sigma gammai gammaa c paramstr nparam time color country h0 d0 e0;
country='SouthAfrica';
...
thetasol=lsqcurvefit(@strainAcase,theta00,time,coviddata(:,1));


%-------------------------------Figures------------------------------------%
%---------------------Fit Plot---------------------%
figure(1)
[t,cases,deaths]=strainAcasedeath(thetasol);
...
%saveas(gcf,['/Users/Qing/Desktop/IDRC/Vaccine shortage/Latex/',[country,'LSQCurveFit.jpg']]);


%-------------------------------Functions------------------------------------%
function casemod=strainAcase(theta,time)
global sigma;
